  ...
  <div class="container-cart">
    ...
    <!-- <div class="button">
      ...
      <button
        @click="placeOrder()"
        class="order-btn"
        v-if="cart && cart.resultData.length > 0"
      >
        Place Order
      </button>
      <button
...
export default {
  setup() {
      ...
      resultData: [
        {
          ...
          product: {
            ...
            productCategoryId:
              '{"_id": "a2fcd286-0116-463a-a24e-3b52964740f4", "productCategoryName": "Phone", "_class": "com.example.product_service.entity.ProductCategory"}',
            price: 20000,
            count: 10,
          },
          merchant: {
        ...
        },
        {
          ...
          product: {
            ...
            merchantId: "0ac22398-1a72-4c19-8417-c1622c5fd78d",
            imageUrl:
              "https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQA4kC19i4C9ZwXVvStpy4UQMHiE4VyVCjmNm7JBDOdCYFvereNU9wZWkS2Z2PAQ6Dpr2RK0QzgnLtAbIQWKIgjl9BHXVqKoA",
            productCategoryId:
              '{"_id": "a2fcd286-0116-463a-a24e-3b52964740f4", "productCategoryName": "Phone", "_class": "com.example.product_service.entity.ProductCategory"}',
            price: 30000,
            count: 10,
    ...
    const FETCH_ORDER = async () => {
      ...
      //     },
      //   }
      const res = await fetch("http://172.20.10.5:9002/orders/orders");
